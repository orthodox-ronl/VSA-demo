---
title: "Troparen en Kondaken voor de Weekdagen (Hemelum)"
sources: 
  - "Hemelum (Heilig Kruis: woensdag en vrijdag)"
  - Liturgikon
---

## Maandag (Heilige Engelen)
...
bidt voor ons om het goede en de grote ge{\na_}{\de_}, * 
// {//gij} Aanvoer{\ders} {/der} {/On_}{\&/li}{\cha_}{\me}lijk{\en}. [:]
:::
...
Want toen hij Hem, die de Profeten hadden ver{/kon__}{\digd_}, * 
in de Jordaan {\met} {/de} {/hand} {/aan_}{\raak_}{\te_}, * 
// toonde hij zich als Pro{feet_}, Verkondiger en Voorloper {\van} {\het} {/&/&/&\god}{\&\de}{/lijk_} {\Woord_}. [:]
:::

{{< pagebreak >}}

## Woensdag, Vrijdag (het Heilig Kruis)
...
Want hun moeiten en dood hebt Gij {\ho_}ger ge{\schat} * 
{/dan} {/al}{/le} {/brand_}{\of_}{\fers_}; * 
// Gij {\Die} {/al}{/&\leen_&~} {/de} {\har_}{\ten_} {\kent}. [:]
:::

{{< pagebreak >}}

## Zaterdag (Koren der Heiligen)
...
gij hebt toegang tot de Ver{\los_}{\ser_}. * 
{/Smeekt} tot {/Hem_}, als {/de} {/Goe_}{\de}, voor {\ons_}, * 
...
Bewaar om hun {/ge}{/be}den Uw {/Kerk} in {\die}pe {\vre_}{\de_}, * 
// door {/de} {/Moe}der {\Gods}, {/Barm}{/har_}{ti_}{\ge_}. [//:]
:::

{{< pagebreak >}}

## Zaterdag (Gestorvenen)
