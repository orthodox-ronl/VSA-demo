...
| `capella/2 - 1e antifoon.mxl` | `2-eerste-antifoon` | liturgiemap-hemelum | `.mscz` | ontvangen | doel-id | bladermap stub (`voorzien`) |
...
| `capella/28a - wij hebben het ware licht aanschouwd.mxl` | `28-wij-hebben-het-ware-licht` | liturgiemap-hemelum | `.mscz` | bladermap | — | bladermap stub |
...
| `vow/Cherubijnenlied-Kastorskij.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/dankzegging_toon_2_Kyiv.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/eind-liturgie.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Eucharistische Canon-Rostov.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Kleine_intocht-moedergods.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Kleine_intocht-weekdagen.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Kleine_intocht-zondag.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon1.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon2.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon3.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon4.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon5.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon6.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon7.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
| `vow/Tropaar-opstanding-toon8.mscz` |  |  | `.mscz` | ontvangen | doel-id |  |
